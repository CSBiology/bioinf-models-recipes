...
At first sight, population growth appears simple. As long as individuals reproduce successfully, the population increases over time. If every individual produces offspring, one might expect the population to continue growing without limit.
...
The **carrying capacity**, usually denoted by \(K\), is the maximum population size that an environment can support over long periods.
...
The carrying capacity emerges because population growth depends on population density.
...
Interestingly, very small populations may also experience reduced growth.
...
Although the examples discussed above originate from ecology, the underlying mathematical principles extend far beyond population biology.
...
- Population dynamics provides a simple model system for studying equilibrium behaviour.
...
Population dynamics illustrates how competing biological processes naturally give rise to equilibrium behaviour. Limited resources prevent unlimited population growth, resulting in a carrying capacity that acts as a stable equilibrium. At the same time, the Allee effect demonstrates that small populations may also become unstable. These examples provide an intuitive biological foundation for understanding equilibrium points and their stability, concepts that extend far beyond ecology to many areas of systems biology.

### Self-check questions

1. Why is unlimited population growth impossible in natural ecosystems?
2. What is meant by the carrying capacity of an environment?
3. What is the difference between density-dependent and density-independent factors?
4. Why can very small populations become unstable?
5. Why is population dynamics a useful model system for studying equilibrium behaviour?